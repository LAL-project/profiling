...
void linarr_crossings(int argc, char *argv[]) {
	...
	// dynamic programming
		...
		linarr_C::profile_algo_list(
		[](const free_tree& t, const vector<linear_arrangement>& arr) {
			return n_crossings_list(t, arr, algorithms_C::dynamic_programming);
		},
		n, T, N
		);
	}
	// ladder
		...
		linarr_C::profile_algo_list(
		[](const free_tree& t, const vector<linear_arrangement>& arr) {
			return n_crossings_list(t, arr, algorithms_C::ladder);
		},
		n, T, N
		);
	}
	// stack based
		...
		linarr_C::profile_algo_list(
		[](const free_tree& t, const vector<linear_arrangement>& arr) {
			return n_crossings_list(t, arr, algorithms_C::stack_based);
		},
		n, T, N
		);
	}
